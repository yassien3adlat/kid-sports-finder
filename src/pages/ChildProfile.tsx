      ...
      <div className="container mx-auto px-4 pb-8 max-w-2xl space-y-5">
        ...
        <Tabs defaultValue="progress" className="w-full">
          <TabsList className="w-full grid grid-cols-3 rounded-xl h-11">
            <TabsTrigger value="progress" className="rounded-lg text-xs font-semibold"><TrendingUp className="w-3.5 h-3.5 ml-1" /> التقدم</TabsTrigger>
            <TabsTrigger value="assessments" className="rounded-lg text-xs font-semibold"><ClipboardCheck className="w-3.5 h-3.5 ml-1" /> الاختبارات</TabsTrigger>
            <TabsTrigger value="stats" className="rounded-lg text-xs font-semibold"><BarChart3 className="w-3.5 h-3.5 ml-1" /> إحصائيات</TabsTrigger>
          </TabsList>
