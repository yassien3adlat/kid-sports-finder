      ...
      <div className="container mx-auto px-4 pb-8 space-y-4">
        ...
        <Card className="shadow-card border-border/50 overflow-hidden">
          <div className="gradient-hero p-5 text-center">
            ...
            <h2 className="text-lg font-black text-primary-foreground">مكتبة الفيديوهات</h2>
            <p className="text-primary-foreground/70 text-xs mt-1">محتوى عربي حصري للأطفال</p>
          </div>
