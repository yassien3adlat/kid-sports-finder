            ...
            {menuItems.map((item, i) => (
              ...
              >
                <CardContent className="p-3 flex flex-col items-center text-center gap-1.5">
                  ...
                  <div>
                    <p className="font-bold text-foreground text-[11px] leading-tight">{item.label}</p>
                    <p className="text-[9px] text-muted-foreground mt-0.5 hidden xs:block">{item.desc}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
